class BlogsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @blog.save
        format.html { redirect_to blogs_url(@blogs), notice: "Blog was successfully created." }
  ...
  def update
    respond_to do |format|
      if @blog.update(blog_params)
        format.html { redirect_to blogs_url(@blogs), notice: "Blog was successfully updated." }
